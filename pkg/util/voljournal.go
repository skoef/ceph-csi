...
Return values:
	...
	- error: non-nil in case of any errors
*/
func (cj *CSIJournal) ReserveName(ctx context.Context, monitors string, cr *Credentials, pool, reqName, namePrefix, parentName, encryptionKmsConfig string) (string, error) {
	var snapSource bool
